...
class Config
{
    ...
    const NICEPAY_ACCESS_TOKEN_URL = "https://www.nicepay.co.id/nicepay/v1.0/access-token/b2b";
    const NICEPAY_GENERATE_VA_URL = "https://www.nicepay.co.id/nicepay/api/v1.0/transfer-va/create-va";
