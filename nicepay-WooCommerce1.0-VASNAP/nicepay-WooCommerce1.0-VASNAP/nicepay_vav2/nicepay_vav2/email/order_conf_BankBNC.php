		...
		<table class="table table-mail" style="width:100%;margin-top:10px;-moz-box-shadow:0 0 5px #afafaf;-webkit-box-shadow:0 0 5px #afafaf;-o-box-shadow:0 0 5px #afafaf;box-shadow:0 0 5px #afafaf;filter:progid:DXImageTransform.Microsoft.Shadow(color=#afafaf,Direction=134,Strength=5)">
			...
			<tr>
				<td class="box" style="background-color:#fbfbfb;border:1px solid #d6d4d4!important;padding:10px!important">
					<p style="margin:3px 0 7px;text-transform:uppercase;font-weight:500;font-size:18px;border-bottom:1px solid #d6d4d4!important;padding-bottom:10px">
						Anda telah memilih untuk membayar menggunakan Bank BNC Virtual Account.
					</p>
					<span style="color:#777">
			...
			<tr>
				<td class="box" style="background-color:#fbfbfb;border:1px solid #d6d4d4!important;padding:10px!important">
					...
					Silakan melakukan pembayaran dengan Bank Transfer <b>Bank BNC (Virtual Account)</b> dengan mengikuti petunjuk berikut :<br/><br/>
					...
					<ol>
						...
						<li>Konfirmasi tagihan pembayaran jika sesuai.</li>
						<li>Masukan PIN</li>
					...
					<ol>
						...
						<li>Pilih 'BNC' sebagai nama bank penerima</li>
						<li>Masukan Nomor VA sebagai rekening penerima</li>
