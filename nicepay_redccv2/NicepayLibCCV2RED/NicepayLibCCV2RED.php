...
include_once ('NicepayRequestorCCV2RED.php');

class NicepayLibCCV2RED {
    // public $tXid;
    // public $authNo;
    // public $bankVacctNo;
    // public $resultCd;
    ...
    public function __construct() {
        $this->request = new NicepayRequestorCCV2RED();
    ...
    // Request VA
    public function requestCCV2RED() {
        // Populate data
        ...
        $this->set('reqClientVer', '');
        $this->set('userSessionID', '697D6922C961070967D3BA1BA5699C2C');
        $this->set('userAgent', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML,like Gecko) Chrome/60.0.3112.101 Safari/537.36');
        $this->set('userLanguage', 'ko-KR,en-US;q=0.8,ko;q=0.6,en;q=0.4');
        $this->set('vacctValidDt', '');
        $this->set('vacctValidTm', '');
        $this->set('merFixAcctId', '');
        $this->set('bankCd', '');
        $this->set('reqDomain', 'merchant.com');
        $this->set('recurrOpt', '1');
        $this->set('shopId', '');
        ...
        $this->checkParam('callBackUrl', '39');

        // Send Request
        $this->request->operation('requestCCV2RED');
