...
class NicepayLoggerCCV2RED {
    ...
    function StartLog($dir, $mid) {
        ...
        $logfile = $dir. "/logs/".CCV2REDConfig::NICEPAY_PROGRAM."_".$this->type."_".$mid."_".date("ymd").".log";
        $this->handle = fopen( $logfile, "a+" );
        if(!$this->handle) {
            return false;
        }

        $this->WriteLog("START ".CCV2REDConfig::NICEPAY_PROGRAM." ".$this->type." (V".CCV2REDConfig::NICEPAY_VERSION."B".CCV2REDConfig::NICEPAY_BUILDDATE."(OS:".php_uname('s').php_uname('r').",PHP:".phpversion()."))");
        return true;
    }
